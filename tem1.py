...
var1=DoubleVar()
var2=DoubleVar()
label=Label(root,text="TEMPRATURE CONVERTER",font=('Arial 30'))
label.pack(side=TOP)
label1=Label(root,text='Temprature in celcius =',fg='black',font=('Arial 25'))
label1.place(x=200,y=200)
label2=Label(root,text='Temprature in fahrenheit =',font=('Arial 25'))
...
label4=Label(root,text='Temprature in fahrenheit =',font=('Arial 25'))
label4.place(x=200,y=400)
label5=Label(root,text='Temprature in celcius =',font=('Arial 25'))
label5.place(x=200,y=500)
entry2=Entry(root,font=('Arial 25'))
